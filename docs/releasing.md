...
3. Packages the chart, creates the GitHub Release `v1.1.0` with the changelog
   ...
   `oci://registry-1.docker.io/shebanglabs/hetzner-server-controller-chart`.
...
helm pull oci://registry-1.docker.io/shebanglabs/hetzner-server-controller-chart --version 1.1.0
```
